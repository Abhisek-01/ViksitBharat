      ...
      <div id="report" className="my-20 min-h-96 w-screen px-10">
        <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center relative z-10">
            {/* <p className="mb-10 font-general text-[10px] uppercase">Report Civic Issue</p> */}
            ...
            {!auth.currentUser && (
              <div className=" bg-blue-600/20 border border-blue-500/50 rounded-lg">
              <div className="mt-6 p-4 bg-blue-600/20 border border-blue-500/50 rounded-lg max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl space-y-6">
              <div>
                <label className="block mb-2 text-left font-medium text-sm">Description *</label>
                <textarea
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  className="w-full p-3 rounded-lg text-black bg-black border-2 border-blue-500/30 focus:border-blue-500 focus:outline-none transition-all text-white"
                  rows={4}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 rounded-lg bg-black text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700 cursor-pointer"
                  required
                />
                {photoPreview && (
                  <div className="mt-4">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-green-600 hover:bg-green-500 disabled:bg-green-800 disabled:cursor-not-allowed text-white py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center"
                    >
                      {isGettingLocation ? (
                        <>
...
>
              ...
              <Button 
                title={auth.currentUser ? "Submit Complaint" : "Sign In to Submit"} 
                containerClass="mt-6 cursor-pointer w-full" 
              />
            </form>

            <p className="mt-6 text-xs text-gray-400">* All fields are required</p>
            <p className="mt-2 text-xs text-gray-500">Rate limit: 1 complaint per 5 minutes • Email confirmation sent</p>
          </div>
        </div>
      </div>
